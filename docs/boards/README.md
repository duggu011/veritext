...
| 26 - Domain Pack and Schema Registry Foundation | [approved](../specs/phase_26_domain_pack_and_schema_registry_foundation.md) | [board](phase_26_domain_pack_and_schema_registry_foundation.md) | ACTIVE - BOARD OPEN |

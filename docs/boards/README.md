...
| 27 - Planner Schema Reuse and Schema-Fit Refusal | [approved](../specs/phase_27_planner_schema_reuse_and_schema_fit_refusal.md) | [board](phase_27_planner_schema_reuse_and_schema_fit_refusal.md) | ACTIVE - BOARD OPEN |

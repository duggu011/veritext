...
**Phase 27 - Planner Schema Reuse and Schema-Fit Refusal** | Status: FINAL GATE READY | Spec: [approved](../specs/phase_27_planner_schema_reuse_and_schema_fit_refusal.md) | Board: [active](phase_27_planner_schema_reuse_and_schema_fit_refusal.md) | Roadmap source: [`docs/PROJECT_OVERVIEW.md`](../PROJECT_OVERVIEW.md), [`docs/phase_26_plus_roadmap.md`](../phase_26_plus_roadmap.md)
...
| 27 - Planner Schema Reuse and Schema-Fit Refusal | [approved](../specs/phase_27_planner_schema_reuse_and_schema_fit_refusal.md) | [board](phase_27_planner_schema_reuse_and_schema_fit_refusal.md) | ACTIVE - FINAL GATE READY |

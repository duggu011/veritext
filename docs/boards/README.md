...
**Phase 31 - Adversarial, Mutation, and Calibration Evaluation** | Status: BOARD OPEN | Spec: [approved](../specs/phase_31_adversarial_mutation_calibration_evaluation.md) | Board: [board](phase_31_adversarial_mutation_calibration_evaluation.md) | Roadmap source: [`docs/PROJECT_OVERVIEW.md`](../PROJECT_OVERVIEW.md), [`docs/phase_26_plus_roadmap.md`](../phase_26_plus_roadmap.md)
...
| 31 - Adversarial, Mutation, and Calibration Evaluation | [approved](../specs/phase_31_adversarial_mutation_calibration_evaluation.md) | [board](phase_31_adversarial_mutation_calibration_evaluation.md) | ACTIVE - BOARD OPEN |

...
**Phase 40 - Signed Reports and Run Diffs** | Status: BOARD OPEN | Spec: [approved](../specs/phase_40_signed_reports_and_run_diffs.md) | Board: [board](phase_40_signed_reports_and_run_diffs.md) | Roadmap source: [`docs/PROJECT_OVERVIEW.md`](../PROJECT_OVERVIEW.md), [`docs/phase_26_plus_roadmap.md`](../phase_26_plus_roadmap.md)
...
| 40 - Signed Reports and Run Diffs | [approved](../specs/phase_40_signed_reports_and_run_diffs.md) | [board](phase_40_signed_reports_and_run_diffs.md) | ACTIVE - BOARD OPEN |

...
**Phase 32 - Boundary-Preserving Ingestion Model** | Status: SPEC DRAFT | Spec: [draft](../specs/phase_32_boundary_preserving_ingestion_model.md) | Board: _(not opened)_ | Roadmap source: [`docs/PROJECT_OVERVIEW.md`](../PROJECT_OVERVIEW.md), [`docs/phase_26_plus_roadmap.md`](../phase_26_plus_roadmap.md)
...
| 32 - Boundary-Preserving Ingestion Model | [draft](../specs/phase_32_boundary_preserving_ingestion_model.md) | _(not opened)_ | ACTIVE - SPEC DRAFT |
